...
const formSchema = z.object({
  query: z
    ...
    .max(20, { message: "Query is too long." }),
});

export function SentimentAITab() {
  const [result, setResult] = useState<AnalyzeMarketSentimentOutput | null>(
    null
  );
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="flex items-center gap-1">
              <span className=" text-center text-yellow-600 text-xs font-normal bg-yellow-50/5 p-0.5 rounded-sm">
                Beta Testing
              </span>
              Analyze market sentiment for any currency pair or asset.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
      ...
      <div className="md:col-span-2">
        <Card className="min-h-[300px]">
          <CardHeader>
            ...
            <CardDescription>
              Generated by AI based on recent news and social media.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading && (
            ...
            {result && (
              <div className="space-y-6">
                ...
                {result.supportingNewsItems &&
                  result.supportingNewsItems.length > 0 && (
                    <div>
